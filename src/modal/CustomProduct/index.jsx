...
import cls from './customProduct.module.scss';
import { useDispatch } from 'react-redux';
import { setModal } from '../../store/slices/modalSlice';
import { useEffect, useState } from 'react';
import { useEditProductMutation, useGetOneProductQuery,
  useGetProductGroupsByHeaderQuery, useGetProductsCategoryByHeadersQuery } from '../../store/query/productQuery';
...
const CustomProduct = () => {
  ...
  const { data: productData, isLoading } = useGetOneProductQuery({ id, token: localStorage.getItem('accessToken') })
        ...
        <div className={cls['create-product-wrapper']}>
          <div className={cls['create-product-body']}>
            <div className={cls['create-product-info']}>
              <h3 className={cls['create-product-title']}>Основная информация</h3>
